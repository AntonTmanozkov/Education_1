...
namespace SOVa
{
    [CreateAssetMenu(menuName = "SOVa/Custom variables/Power Float")]
    public class PowerFloatParametr : Float
    {
        ...
        public override float Value
        {
            get
            {
                ...
                #endif
                var result = Mathf.Pow(_multiply, _level - 1);
                return result;
            } 
        ...
        #if UNITY_EDITOR
        [CustomEditor(typeof(PowerFloatParametr))]
        private class LinearFloatParametrEditor : Editor
        {
            private SOVa.PowerFloatParametr _target;

            private void Awake()
            {
                _target = (SOVa.PowerFloatParametr)target;
            }
